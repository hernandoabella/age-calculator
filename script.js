const months = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
  ...
  const modal = document.querySelector(".age_main_big_container");
  ...
  // Función para cerrar el modal y mostrar el container nuevamente
  function closeModal() {
  ...
  btnCalcular.addEventListener("click", ageCalculate);

  // Agregar el evento click al botón "Cerrar" del modal
  btnCerrar.addEventListener("click", closeModal);

  // Cuando el usuario haga clic fuera del modal, cerrarlo y mostrar el container
